...
def hexagon(name, a, height):
    '''
    Parameters:
    @a: the hexagon side length
    @height: the height of the hexagon prism

    Returns:
    bpy_types.Mesh that is an extruded 3D hexagonal prism
    '''
